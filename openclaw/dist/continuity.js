 ...
 *
 * storePendingContinuityHint() lstat-checks the session directory, but a TOCTOU
...
function storePendingContinuityHint(sessionId, hint) {
    ...
    try {
        ...
        writeFileNoFollow(filePath, JSON.stringify({ hint, storedAt: new Date().toISOString() }), 0o600);
    }
    catch {
